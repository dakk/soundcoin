...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Soundcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    /*{"soundcointools.com", "dnsseed.cointools.com"},
    {"soundcoinpool.org", "dnsseed.litecoinpool.org"},*/
    //{"sagregna.it", "sagregna.it"}
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Soundcoin is probably already running."), addrBind.ToString().c_str());
        else
