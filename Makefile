#############################################################################
# Makefile for building: soundcoin-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: Thu May 15 22:11:36 2014
# Project:  soundcoin-qt.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile soundcoin-qt.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtNetwork -I/usr/include/qt4/QtGui -I/usr/include/qt4/QtWebKit -I/usr/include/qt4 -Isrc -Isrc/json -Isrc/qt -I/usr/include/db4.8 -Isrc/leveldb/include -Isrc/leveldb/helpers -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -fstack-protector-all -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib64/qt4 -lminiupnpc /home/dak/Dropbox/ActiveProjects/SoundCoin/client/soundcoin/src/leveldb/libleveldb.a /home/dak/Dropbox/ActiveProjects/SoundCoin/client/soundcoin/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lQtWebKit -lQtGui -L/usr/lib64 -L/usr/lib64/qt4 -L/usr/X11R6/lib -lQtNetwork -lQtCore -lgthread-2.0 -lglib-2.0 -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
SOURCES       = src/qt/bitcoin.cpp \
		...
		src/x11/keccak.c \
		src/x11/skein.c \
		src/qt/newspage.cpp build/moc_bitcoingui.cpp \
...
$(TARGET): /home/dak/Dropbox/ActiveProjects/SoundCoin/client/soundcoin/src/leveldb/libleveldb.a /home/dak/Dropbox/ActiveProjects/SoundCoin/client/soundcoin/build/build.h build/ui_sendcoinsdialog.h build/ui_coincontroldialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h build/ui_newspage.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: soundcoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile soundcoin-qt.pro
...
dist: 
	@$(CHK_DIR_EXISTS) build/soundcoin-qt0.8.7.1 || $(MKDIR) build/soundcoin-qt0.8.7.1 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/soundcoin-qt0.8.7.1/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/soundcoin-qt0.8.7.1/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/coincontroldialog.h src/qt/coincontroltreewidget.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/coincontrol.h src/compat.h src/sync.h src/util.h src/hash.h src/uint256.h src/serialize.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/bloom.h src/mruset.h src/checkqueue.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/qt/walletview.h src/qt/walletstack.h src/qt/walletframe.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/paymentserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/scrypt.h src/version.h src/netbase.h src/clientversion.h src/txdb.h src/leveldb.h src/threadsafety.h src/limitedmap.h src/qt/macnotificationhandler.h src/qt/splashscreen.h src/x11/sph_blake.h src/x11/sph_bmw.h src/x11/sph_groestl.h src/x11/sph_jh.h src/x11/sph_keccak.h src/x11/sph_skein.h src/x11/sph_types.h src/qt/newspage.h build/soundcoin-qt0.8.7.1/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/soundcoin-qt0.8.7.1/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/coincontroldialog.cpp src/qt/coincontroltreewidget.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/hash.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/bloom.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/qt/walletview.cpp src/qt/walletstack.cpp src/qt/walletframe.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/paymentserver.cpp src/qt/rpcconsole.cpp src/scrypt.cpp src/noui.cpp src/leveldb.cpp src/txdb.cpp src/qt/splashscreen.cpp src/x11/blake.c src/x11/bmw.c src/x11/groestl.c src/x11/jh.c src/x11/keccak.c src/x11/skein.c src/qt/newspage.cpp build/soundcoin-qt0.8.7.1/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/coincontroldialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui src/qt/forms/newspage.ui build/soundcoin-qt0.8.7.1/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/soundcoin-qt0.8.7.1/ && (cd `dirname build/soundcoin-qt0.8.7.1` && $(TAR) soundcoin-qt0.8.7.1.tar soundcoin-qt0.8.7.1 && $(COMPRESS) soundcoin-qt0.8.7.1.tar) && $(MOVE) `dirname build/soundcoin-qt0.8.7.1`/soundcoin-qt0.8.7.1.tar.gz . && $(DEL_FILE) -r build/soundcoin-qt0.8.7.1


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/dak/Dropbox/ActiveProjects/SoundCoin/client/soundcoin/src/leveldb/libleveldb.a; cd /home/dak/Dropbox/ActiveProjects/SoundCoin/client/soundcoin/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/dak/Dropbox/ActiveProjects/SoundCoin/client/soundcoin/src/leveldb/libleveldb.a: FORCE
	cd /home/dak/Dropbox/ActiveProjects/SoundCoin/client/soundcoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-pipe -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/dak/Dropbox/ActiveProjects/SoundCoin/client/soundcoin/build/build.h: FORCE
	cd /home/dak/Dropbox/ActiveProjects/SoundCoin/client/soundcoin; /bin/sh share/genbuild.sh /home/dak/Dropbox/ActiveProjects/SoundCoin/client/soundcoin/build/build.h
...
build/moc_newspage.cpp: src/qt/newspage.h
	/usr/bin/moc $(DEFINES) $(INCPATH) src/qt/newspage.h -o build/moc_newspage.cpp
...
build/ui_newspage.h: src/qt/forms/newspage.ui
	/usr/bin/uic src/qt/forms/newspage.ui -o build/ui_newspage.h
...
build/blake.o: src/x11/blake.c src/x11/sph_blake.h \
		src/x11/sph_types.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/blake.o src/x11/blake.c

build/bmw.o: src/x11/bmw.c src/x11/sph_bmw.h \
		src/x11/sph_types.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/bmw.o src/x11/bmw.c

build/groestl.o: src/x11/groestl.c src/x11/sph_groestl.h \
		src/x11/sph_types.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/groestl.o src/x11/groestl.c

build/jh.o: src/x11/jh.c src/x11/sph_jh.h \
		src/x11/sph_types.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/jh.o src/x11/jh.c

build/keccak.o: src/x11/keccak.c src/x11/sph_keccak.h \
		src/x11/sph_types.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/keccak.o src/x11/keccak.c

build/skein.o: src/x11/skein.c src/x11/sph_skein.h \
		src/x11/sph_types.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/skein.o src/x11/skein.c

build/newspage.o: src/qt/newspage.cpp src/qt/newspage.h \
		build/ui_newspage.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/newspage.o src/qt/newspage.cpp
...
build/moc_newspage.o: build/moc_newspage.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_newspage.o build/moc_newspage.cpp
